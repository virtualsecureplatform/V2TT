...
int main() {
    ...
    std::cin >> plaintext;
    LweSample* ciphertext = new_gate_bootstrapping_ciphertext_array(18, params);
    ...
    for (int i=0; i<8; i++) {
        bootsSymEncrypt(&ciphertext[i+10], (plaintext>>i)&1, key);
    }
    ...
    delete_gate_bootstrapping_ciphertext_array(18, ciphertext);
